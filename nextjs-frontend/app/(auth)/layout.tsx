...
import {
  LayoutDashboard, ArrowRightLeft, Link2, Network, Server, Users, Clock, Settings,
  Menu, ChevronDown, LogOut, KeyRound, Shield, Inbox, Award, Rss,
  Activity, Search, Layers, Globe, ScrollText, User,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { path: '/route', labelKey: 'nav.route', icon: <Network className="h-4 w-4" />, adminOnly: true, section: 'GOST', sectionKey: 'GOST' },
  ...
  { path: '/group', labelKey: 'nav.group', icon: <Layers className="h-4 w-4" />, adminOnly: true, section: 'system', sectionKey: 'nav.system' },
  { path: '/ddns', labelKey: 'nav.ddns', icon: <Globe className="h-4 w-4" />, adminOnly: true, section: 'system', sectionKey: 'nav.system' },
  { path: '/audit', labelKey: 'nav.audit', icon: <Search className="h-4 w-4" />, adminOnly: true, section: 'system', sectionKey: 'nav.system' },
  { path: '/logs', labelKey: 'nav.logs', icon: <ScrollText className="h-4 w-4" />, adminOnly: true, section: 'system', sectionKey: 'nav.system' },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 text-center">
        <p className="text-xs text-muted-foreground">
          Powered by{' '}
          <a href="https://github.com/kukumi1/flux-panel-plus" target="_blank" rel="noopener noreferrer"
            className="hover:text-foreground transition-colors">Flux Panel Plus</a>
        </p>
      </div>
    </div>
  );
